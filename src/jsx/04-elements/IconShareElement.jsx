const IconShareElement = () => {
    return(
        <div className="tweet__stats-container tweet__stats-container--share">
            <div className="tweet__stats-icon">
            ...
            <span className="tweet__stats-number" />
        </div>
    )
}

export { IconShareElement }